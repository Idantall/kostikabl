      ...
      building.floors.forEach(floor => {
        floor.apartments.forEach(apt => {
          ...
          const data = [
            ...
            [],
            ['מס\' פתח', 'מיקום בדירה', 'פרט חוזה', 'פרט יצור', 'גובה', 'רוחב', 'גובה מהריצוף', 'ציר מבט מבפנים', 'ממד כיס בצד', 'עומק עד הפריקסט', 'גליף', 'מדרגה בשיש', 'מנואלה', 'צד מנוע', 'הערות', 'כנף פנימית מבט פנים', 'ציר מבט פנים פתיחה פנימה', 'ציר מבט פנים פתיחה החוצה'],
            ...apt.rows.map(row => [
